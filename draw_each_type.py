...
def gen_bloxplot():
    ...
    for alphabet in gconfig.english_type_range:
        ...
        if not os.path.exists(csv_path):
            ...
            boxchart_att = df[['Att 0s', 'Att 1s', 'Att 2s']].plot.box(ylim = (40, 100), color = boxplot_color, sym = 'r+', grid = True)
            ...
            boxchart_med = df[['Med 0s', 'Med 1s', 'Med 2s']].plot.box(ylim = (40, 100), color = boxplot_color, sym = 'r+', grid = True)
